...
const WithdrawalManagement = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-2" style={{ fontFamily: 'Jost, sans-serif' }}>
              Withdrawal Management
            </h1>
            <p className="text-xs sm:text-sm md:text-base text-white/90" style={{ fontFamily: 'Poppins, sans-serif' }}>
              Process withdrawal requests with support for Stripe Connect and Bank Transfers
            </p>
          </div>
          <BanknotesIcon className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 text-white/80 flex-shrink-0" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4">
        <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg border border-gray-100">
          <div className="flex items-center">
            <div className="bg-orange-100 p-2 sm:p-3 rounded-lg sm:rounded-xl flex-shrink-0">
              <ClockIcon className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-orange-600" />
            </div>
            <div className="ml-2 sm:ml-3 md:ml-4 min-w-0">
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 truncate" style={{ fontFamily: 'Jost, sans-serif' }}>
                {stats.pending}
              </p>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg border border-gray-100">
          <div className="flex items-center">
            <div className="bg-blue-100 p-2 sm:p-3 rounded-lg sm:rounded-xl flex-shrink-0">
              <CheckCircleIcon className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-blue-600" />
            </div>
            <div className="ml-2 sm:ml-3 md:ml-4 min-w-0">
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 truncate" style={{ fontFamily: 'Jost, sans-serif' }}>
                {stats.approved}
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg border border-gray-100">
          <div className="flex items-center">
            <div className="bg-purple-100 p-2 sm:p-3 rounded-lg sm:rounded-xl flex-shrink-0">
              <ClockIcon className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-purple-600" />
            </div>
            <div className="ml-2 sm:ml-3 md:ml-4 min-w-0">
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 truncate" style={{ fontFamily: 'Jost, sans-serif' }}>
                {stats.processing}
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg border border-gray-100">
          <div className="flex items-center">
            <div className="bg-green-100 p-2 sm:p-3 rounded-lg sm:rounded-xl flex-shrink-0">
              <CheckCircleIcon className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-green-600" />
            </div>
            <div className="ml-2 sm:ml-3 md:ml-4 min-w-0">
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 truncate" style={{ fontFamily: 'Jost, sans-serif' }}>
                {stats.completed}
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg border border-gray-100">
          <div className="flex items-center">
            <div className="bg-green-100 p-2 sm:p-3 rounded-lg sm:rounded-xl flex-shrink-0">
              <BanknotesIcon className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-green-600" />
            </div>
            <div className="ml-2 sm:ml-3 md:ml-4 min-w-0">
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 truncate" style={{ fontFamily: 'Jost, sans-serif' }}>
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          <div className="flex flex-col sm:flex-row items-stretch gap-3">
            ...
            <div className="flex items-center gap-2">
              <FunnelIcon className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 flex-shrink-0" />
              <select
                value={selectedFilter}
                onChange={(e) => setSelectedFilter(e.target.value)}
                className="flex-1 sm:flex-none bg-gray-100 border-0 rounded-xl py-2.5 sm:py-2 px-3 focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all duration-200 text-sm sm:text-base"
                style={{ fontFamily: 'Poppins, sans-serif' }}
              >
            ...
            <button
              ...
              className="flex items-center justify-center px-4 py-2.5 sm:py-2 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 rounded-xl transition-colors text-sm sm:text-base"
            >
