...
async getFirebaseEvents(period = '24h', eventFilter = 'all') {
  const response = await fetch('https://us-central1-muslifie-49464.cloudfunctions.net/getFirebaseEvents', {
    method: 'POST',
...
async getUserBehavior(period = '24h') {
  const response = await fetch('https://us-central1-muslifie-49464.cloudfunctions.net/getUserBehavior', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async getPerformanceData(period = '24h') {
  const response = await fetch('https://us-central1-muslifie-49464.cloudfunctions.net/getPerformanceData', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ period })
  });
